...
module Threadring =
    ...
    let Create processCount roundCount : FIO<int64, obj> =
        ...
        !> (Timer.ChannelEffect processCount 1 processCount timerChan) >> fun fiber ->
...
module Big =
    ...
    let Create processCount roundCount : FIO<int64, obj> =
        ...
        !> (Timer.ChannelEffect processCount processCount processCount timerChan) >> fun fiber ->
...
module Bang =
    ...
    let Create processCount roundCount : FIO<int64, obj> =
        ...
        !> (Timer.ChannelEffect (processCount + 1) (processCount + 1) 1 timerChan) >> fun fiber ->
        (Timer.ChannelTimerMessage.Chan goChan) *> timerChan >> fun _ -> 
...
module Spawn =
    ...
    let Create processCount : FIO<int64, obj> =
        ...
        let stopwatch = Stopwatch()
        !> (Timer.StopwatchEffect processCount timerChan) >> fun fiber ->
        stopwatch.Start()
